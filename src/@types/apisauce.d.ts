...
export interface ApisauceInstance {
    ...
    get: <T, U = T>(url: string, params?: any, axiosConfig?: AxiosRequestConfig) => Promise<ApiResponse<T, U>>
    delete: <T, U = T>(url: string, params?: any, axiosConfig?: AxiosRequestConfig) => Promise<ApiResponse<T, U>>
    head: <T, U = T>(url: string, params?: any, axiosConfig?: AxiosRequestConfig) => Promise<ApiResponse<T, U>>
    ...
    link: <T, U = T>(url: string, params?: any, axiosConfig?: AxiosRequestConfig) => Promise<ApiResponse<T, U>>
    unlink: <T, U = T>(url: string, params?: any, axiosConfig?: AxiosRequestConfig) => Promise<ApiResponse<T, U>>
}
